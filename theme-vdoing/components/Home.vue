  ...
  <div class="home-wrapper">
    ...
    <div class="banner"
      ...
      <div class="banner-conent"
        ...
        ">
        <header class="hero">
          <h1 v-if="homeData.heroText"
              id="main-title">
            {{ homeData.heroText }}
          </h1>
          <p v-if="homeData.tagline"
             class="description">
            {{ homeData.tagline }}
          </p>
          <p class="action"
      ...
      <template #mainRight>
        ...
        <CategoriesBar v-if="
          ...
          "
                       ...
                       :length="10" />
        <TagsBar v-if="$themeConfig.tag !== false && $categoriesAndTags.tags.length"
                 :tagsData="$categoriesAndTags.tags"
                 :length="30" />
        <div class="custom-html-box card-box"
             v-if="homeSidebarB"
             v-html="homeSidebarB"></div>
      </template>
    </MainLayout>
  </div>
</template>
  ...
  computed: {
    ...
    bannerBgStyle () {
      ...
      if (!bannerBg || bannerBg === 'auto') { // 默认
        return 'background-image: linear-gradient(90deg, rgba(50, 0, 0, 0.05) 3%, rgba(0, 0, 0, 0) 3%), linear-gradient(360deg, rgba(50, 0, 0, 0.05) 3%, rgba(0, 0, 0, 0) 3%);background-size: 20px 20px;background-position: center center'
